...
export async function getInfoHeader(
  windowName: string,
  windowFormat: any,
  registerID: number | string | string[] | undefined,
) {
  if (registerID === undefined) {
    ...
    const response = await api.post(
      `${API_PATH}${windowName}/0?key_value=${registerID}`,
      windowFormat,
    );
    return response.data;
  }
...
export async function getNextHeaderID(
  windowName: string,
  windowFormat: any,
  registerID: number | string | undefined,
) {
  if (registerID === undefined) {
    ...
    const response = await api.post(
      `${API_PATH}${windowName}/0?key_value=${registerID}&next_value=true`,
      windowFormat,
    );
    return response.data;
  }
...
export async function getPrevHeaderID(
  windowName: string,
  windowFormat: any,
  registerID: number | string | undefined,
) {
  if (registerID === undefined) {
    ...
    const response = await api.post(
      `${API_PATH}${windowName}/0?key_value=${registerID}&prev_value=true`,
      windowFormat,
    );
    return response.data;
  }
...
export async function getInfoDetails(
  ...
  if (registerID === undefined) {
    ...
    const response = await api.post(
      `${API_PATH}${windowName}/${detailID}?key_value=${registerID}`,
      windowFormat,
    );
    return response.data;
  }
...
export async function deleteRegister(
  ...
  const response = await api.delete(`${API_PATH}${windowName}/${detailID}/${registerID}`, {
    data: windowFormat,
  });
  return response.data;
}
...
export async function saveHeader(
  windowName: string,
  detailID: number,
  registerID: number | string | boolean | null | undefined,
  formData: FormData,
) {
